...
In some cases, one Qubes developer may start working on an issue, then another one takes over some time later. If you send logs or other data the first developer, the second developer may need access to that date. Therefore, by sharing data with a member of the Qubes team, you thereby grant them permission to share that data with the rest of the Qubes team. Please do not share any data with a member of the Qubes team unless you are comfortable with the entire team having access to that data. (This is also why it's important for you to leave a comment on the issue stating that you emailed data to a specific developer, as it allows other developers to know whom to ask for the data.)
