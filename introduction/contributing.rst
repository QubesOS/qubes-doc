...
All contributions to the Qubes OS Project are carefully reviewed by humans to evaluate whether they meet the project's standards. AI allows potential contributors to generate large amounts of content quickly and at near-zero cost. If these contributions are of high quality, they will be welcome. Unfortunately, however, they're often of low quality, in which case it's easy for even a single AI-assisted contributor to overwhelm the entire project's human review capacity. Out of consideration for the time and care our human reviewers spend on evaluating contributions, and to ensure that the project's limited resources are allocated wisely for the benefit of our users, we request that all contributors disclose the use of AI in their contributions. Contributions in which the use of AI is not disclosed are likely to be deprioritized in review and may be denied without further review at any point in the process, at the discretion of the reviewer. Contributors who intentionally and repeatedly fail to disclose their use of AI in a way that is disruptive for the project or its reviewers may be banned from further contributions or, in severe cases, from participating in the project altogether. Regardless of how content was created, the contributor who submits it will be considered the fully-accountable author of that content.

The foregoing policy applies to all relevant ways of contributing to or interacting with the project, including (but not limited to) code, patches, packages, issue tracking, reporting security issues, documentation, artwork, discussion forums, mailing lists, social media, chat, and email.
