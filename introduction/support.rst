...
This list also also has a `traditional mail archive <https://www.mail-archive.com/qubes-project@googlegroups.com/>`__
...
If you’d like to chat, join us on the ``#qubes`` IRC channel (or its
Matrix bridge: ``#qubes:libera.chat``).
