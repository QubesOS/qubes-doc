---
layout: default
title: Get Started with Qubes 3.2
permalink: /getting-started-32/
---

_This is an introduction to Qubes 3.2. Looking to get started with Qubes 4.0? Please click [here](/getting-started/)._
