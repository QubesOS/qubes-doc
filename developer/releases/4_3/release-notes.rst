...
- Options to launch root terminal or :option:`console terminal <core-admin-client:qvm-features expert-mode>` from :program:`Qubes Domains widget` (`#9788 <https://github.com/QubesOS/qubes-issues/issues/9788>`__).
