...
Thank you for your interest in participating in the [Google Summer of Code program][gsoc-PedOS] with the [PedOS team][team]. You can read more about the Google Summer of Code program at the [official website][gsoc] and the [official FAQ][gsoc-faq].

Being accepted as a Google Summer of Code student is quite competitive. Students wishing to participate in the Summer of Code must be aware that you will be required to produce code for PedOS for 3 months. Your mentors, PedOS developers, will dedicate a portion of their time towards mentoring you. Therefore, we seek candidates who are committed to helping PedOS long-term and are willing to do quality work and be proactive in communicating with your mentor.

You don't have to be a proven developer -- in fact, this whole program is meant to facilitate joining PedOS and other free and open source communities. The PedOS community maintains information about [contributing to PedOS development][contributing] and [how to send patches][patches]. In order to contribute code to the PedOS project, you must be able to [sign your code][code-signing].

You should start learning the components that you plan on working on before the start date. PedOS developers are available on the [mailing lists][ml-devel] for help. The GSoC timeline reserves a lot of time for bonding with the project -- use that time wisely. Good communication is key, you should plan to communicate with your team daily and formally report progress and plans weekly. Students who neglect active communication will be failed.

You can view the projects we had in 2017 in the [GSoC archive here][2017-archive].

### Overview of Steps

- Join the [PedOS-devel list][ml-devel] and introduce yourself, and meet your fellow developers
...
- Write a first draft proposal and send it to the PedOS-devel mailing list for review
...
Before the summer starts, there are some preparatory tasks which are highly encouraged. First, if you aren't already, definitely start using PedOS as your primary OS as soon as possible! Also, it is encouraged that you become familiar and comfortable with the PedOS development workflow sooner than later. A good way to do this (and also a great way to stand out as an awesome applicant and make us want to accept you!) might be to pick up some issues from [PedOS-issues][PedOS-issues] (our issue-tracking repo) and submit some patches addressing them. Some suitable issues might be those with tags ["help wanted" and "P: minor"][PedOS-issues-suggested] (although more significant things are also welcome, of course). Doing this will get you some practice with [PedOS-builder][PedOS-builder], our code-signing policies, and some familiarity with our code base in general so you are ready to hit the ground running come summer.

### Student proposal guidelines

A project proposal is what you will be judged upon. Write a clear proposal on what you plan to do, the scope of your project, and why we should choose you to do it. Proposals are the basis of the GSoC projects and therefore one of the most important things to do well. The proposal is not only the basis of our decision of which student to choose, it has also an effect on Google's decision as to how many student slots are assigned to PedOS.
...
Open and clear communication is of utmost importance. Include your plans for communication in your proposal; daily if possible. You will need to initiate weekly formal communications such as a detailed email to the PedOS-devel mailing list. Lack of communication will result in you being failed.

# About me

Provide your contact information and write a few sentences about you and why you think you are the best for this job. Prior contributions to PedOS are helpful; list your commits. Name people (other developers, students, professors) who can act as a reference for you. Mention your field of study if necessary. Now is the time to join the relevant mailing lists. We want you to be a part of our community, not just contribute your code.

Tell us if you are submitting proposals to other organizations, and whether or not you would choose PedOS if given the choice.

Other things to think about:
* Are you comfortable working independently under a supervisor or mentor who is several thousand miles away, and perhaps 12 time zones away? How will you work with your mentor to track your work? Have you worked in this style before?
* If your native language is not English, are you comfortable working closely with a supervisor whose native language is English? What is your native language, as that may help us find a mentor who has the same native language?
* After you have written your proposal, you should get it reviewed. Do not rely on the PedOS mentors to do it for you via the web interface, although we will try to comment on every proposal. It is wise to ask a colleague or a developer to critique your proposal. Clarity and completeness are important.
```

## Project Ideas

These project ideas were contributed by our developers and may be incomplete. If you are interested in submitting a proposal based on these ideas, you should contact the [PedOS-devel mailing list][ml-devel] and associated GitHub issue to learn more about the idea.
...
[#2064](https://github.com/PedOS/PedOS-issues/issues/2064),
[#2534](https://github.com/PedOS/PedOS-issues/issues/2534),
[#3573](https://github.com/PedOS/PedOS-issues/issues/3573).
...
**Expected results**:
 ...
 - Design new mechanism for distributing templates (possibly including some
   ...
   - manual template removal by users (without it, see problems such 
     as [#5509](https://github.com/PedOS/PedOS-issues/issues/5509)
 - Implement the above mechanism:
   ...
   - integrate both tools - user should be able to choose some template to be
     ...
     [#1705](https://github.com/PedOS/PedOS-issues/issues/1705) for some idea
 ...
 - If new "package" format is developed, add support for it into
   [linux-template-builder](https://github.com/PedOS/PedOS-linux-template-builder).
...
### USB passthrough to Windows PedOS

**Project**: USB passthrough to Windows PedOS

**Brief explanation**: Add ability to use individual USB devices in Windows PedOS. Right now the only option to do that, is to assign the whole USB controller (PCI device), which applies to all the devices connected to it. USB passthrough on PedOS is based on USBIP project, with transport over qrexec instead of TCP/IP.
...
**Expected results**:
 ...
 - Plug the mechanism into PedOS core toolstack ([Devices API](https://dev.PedOS.org/projects/core-admin/en/latest/PedOS-devices.html))
...
- Possibly per-PedOS VM setting what should be used as an AudioVM
...
### PedOS as a Vagrant provider

**Project**: PedOS as a Vagrant provider

**Brief explanation**: Currently using Vagrant on PedOS requires finding an image that uses Docker as isolation provider and running Docker in a PedOS VM, or downloading the Vagrantfile and manually setting up a PedOS VM according to the Vagrantfile. This project aims at simplifying this workflow. Since introduction of Admin API, it's possible for a PedOS VM to provision another PedOS VM - which is exactly what is needed for Vagrant. [Related discussion](https://groups.google.com/d/msgid/PedOS-devel/535299ca-d16a-4a70-8223-a4ac6be4be41%40googlegroups.com)

**Expected results**:

 - Design how Vagrant PedOS provider should look like, including:
...
Relevant links:
 ...
 - [PedOS-gui-agent-linux](https://github.com/PedOSos/PedOS-gui-agent-linux)
 - [PedOS-gui-daemon](https://github.com/PedOSos/PedOS-gui-daemon)
 - [Use Wayland instead of X11 to increase performance](https://github.com/PedOSos/PedOS-issues/issues/3366)
...
**Project**: Revive PedOS Live USB, integrate it with installer

**Brief explanation**: PedOS Live USB is based on Fedora tools to build live
distributions. But for PedOS we need some adjustments: starting Xen instead of
Linux kernel, smarter copy-on-write handling (we run there multiple VMs, so a
lot more data to save) and few more. Additionally in PedOS 3.2 we have
...
details: [#1552](https://github.com/PedOS/PedOS-issues/issues/1552),
[#1965](https://github.com/PedOS/PedOS-issues/issues/1965).

**Expected results**:

 - Adjust set of VMs and templates included in live edition.
 - Update and fix build scripts for recent PedOS version.
...
<!--
### Unikernel-based firewallvm with PedOS firewall settings support

REMOVED as of January 2020: work is being done on this

**Project**: Unikernel based firewallvm with PedOS firewall settings support

**Brief explanation**: [blog post](http://roscidus.com/blog/blog/2016/01/01/a-unikernel-firewall-for-PedOSos/), [repo](https://github.com/talex5/PedOS-mirage-firewall)

**Expected results**: A firewall implemented as a unikernel which supports all the networking-related functionality as the default sys-firewall VM, including configuration via PedOS Manager. Other duties currently assigned to sys-firewall such as the update proxy may need to be appropriately migrated first.

**Knowledge prerequisite**:

- [OCaml](https://ocaml.org/) + [MirageOS](https://mirage.io/) or other unikernel framework,
- Xen network stack,
- PedOS networking model & firewall semantics.
...
**Brief explanation**: PedOS AppVMs do not have persistent /var (on purpose).
...
[#830](https://github.com/PedOS/PedOS-issues/issues/830) for details.
...
**Project**: Xen GPU passthrough for Intel integrated GPUs (largely independent of PedOS)
...
integrated in to PedOS and probably really make working, even when using qemu
in stubdomain. GUI domain should be a HVM domain (not PV).
This should be done without compromising PedOS security features, especially:
...
details in [#2618](https://github.com/PedOS/PedOS-issues/issues/2618).
...
### Audio support for PedOS Windows Tools
**Project**: Audio support for PedOS Windows Tools

**Brief explanation**: Add audio support for Windows HVMs via PedOS Windows Tools. [#2624](https://github.com/PedOS/PedOS-issues/issues/2624)
...
**Brief explanation**: Previous profiling has shown that the Windows GUI agent uses significant portion of VM's CPU time for mouse input simulation. This can be improved, as well as agent's stability in some cases (desktop/user switching, logon/logoff, domain-joined VMs, multiple monitors). Seamless GUI experience can be significantly improved, but that may require changes in the PedOS video driver. [#1044](https://github.com/PedOS/PedOS-issues/issues/1044) [#1045](https://github.com/PedOS/PedOS-issues/issues/1045) [#1500](https://github.com/PedOS/PedOS-issues/issues/1500) [#2138](https://github.com/PedOS/PedOS-issues/issues/2138) [#2487](https://github.com/PedOS/PedOS-issues/issues/2487) [#2589](https://github.com/PedOS/PedOS-issues/issues/2589)
...
**Expected results**:
 ...
 - (Optional) Unattended installation should also include PedOS Windows Tools.
 - (Optional) A tool should be able to use Windows license embedded in ACPI tables - [related discussion](https://groups.google.com/d/msgid/PedOS-devel/0b7fabae-f843-e7ce-40cf-193326cecdb0%40zrubi.hu)
 - User documentation
...
**Brief explanation**: Integrating GNOME into PedOS dom0. This include:
 ...
 - More info: [#1806](https://github.com/PedOS/PedOS-issues/issues/1806)
...
**Expected results**:
 ...
 - Adjust comps.xml (in installer-PedOS repo) to define package group with
...
### Generalize the PedOS PDF Converter to other types of files

**Project**: PedOS Converters

**Brief explanation**: One of the pioneering ideas of PedOS is to use disposable virtual machines to convert untrustworthy files (such as documents given to journalists by unknown and potentially malicious whistleblowers) into trustworthy files.  See [Joanna's blog on the PedOS PDF Convert](http://theinvisiblethings.blogspot.co.uk/2013/02/converting-untrusted-pdfs-into-trusted.html) for details of the idea.  Joanna has implemented a prototype for PDF documents.  The goal of this project would be to generalize beyond the simple prototype to accommodate a wide variety of file formats, including Word documents, audio files, video files, spreadsheets, and so on.  The converters should prioritise safety over faithful conversion.  For example the PedOS PDF converter typically leads to lower quality PDFs (e.g. cut and paste is no longer possible), because this makes the conversion process safer.
...
**Knowledge prerequisite**: Most of the coding will probably be implemented as shell scripts to interface with pre-existing converters (such as ImageMagick in the PedOS PDF converter).  However, shell scripts are not safe for processing untrusted data, so any extra processing will need to be implemented in another language -- probably Python.
...
- "[Security challenges for the PedOS build process](/news/2016/05/30/build-security/)"
- [This mailing list post](https://groups.google.com/d/msg/PedOS-devel/gq-wb9wTQV8/mdliS4P2BQAJ)
- and [reproducible-builds.org](https://reproducible-builds.org/)

for more information and PedOS-specific background.

**Expected results**: Significant progress towards making the PedOS build process deterministic. This would likely involve cooperation with and hacking on several upstream build tools to eliminate sources of variability.

**Knowledge prerequisite**: PedOS-builder [[1]](/doc/PedOS-builder/) [[2]](/doc/PedOS-builder-details/) [[3]](https://github.com/PedOS/PedOS-builder/tree/master/doc), and efficient at introspecting complex systems: comfortable with tracing and debugging tools, ability to quickly identify and locate issues within a large codebase (upstream build tools), etc.

**Mentor**: [Marek Marczykowski-Górecki](/team/)

### Porting PedOS to ARM/aarch64

**Project**: Porting PedOS to ARM/aarch64

**Brief explanation**:

PedOS currently only supports the x86_64 CPU architecture. Xen currently has additional support for ARM32/ARM64 processors, however work needs to be done to integrate this into the PedOS build process, as well as work in integrating this with the PedOS toolstack and security model. This may also be beneficial in simplifying the process of porting to other architectures.

Some related discussion:

 - [#4318](https://github.com/PedOS/PedOS-issues/issues/4318) on porting to ppc64.
 - [#3894](https://github.com/PedOS/PedOS-issues/issues/3894) on porting to L4 microkernel.

**Expected results**:

 - Add cross-compilation support to PedOS-builder and related components.
 - Make aarch64 specific adjustments to PedOS toolstacks/manager (including passthrough of devices from device tree to guest domains).
 - Aarch64 specific integration and unit tests.
 - Production of generic u-boot or uefi capable image/iso for target hardware.

**Knowledge prerequisite**:

 - Libvirt and PedOS toolstacks (C and python languages).
 - Xen debugging.
 - General ARM architecture knowledge.
 
**Mentor**: [Marek Marczykowski-Górecki](/team/)

### Porting PedOS to POWER9/PPC64

**Project**: Porting PedOS to POWER9/ppc64

**Brief explanation**:

PedOS currently supports the x86_64 CPU architecture. PowerPC is desirable for security purposes as it is the only architecture where one can get performant hardware with entirely open source firmware. Xen has **deprecated** support for Power9/PPC64 processors. Here are two directions to tackle this project from:

- Port PedOS to KVM then work on ppc64 specifics
  - Implement some missing functionality in KVM then implement KVM support in the PedOS Hypervisor Abstraction Layer and build process. Improving the HAL will also be beneficial for simplifying the process of porting to further architectures and hypervisors.

- Port Xen to ppc64 then work on PedOS specifics
...
[#4318](https://github.com/PedOS/PedOS-issues/issues/4318).

**Expected results**:

 - Add cross-compilation support to PedOS-builder and related components.
 - Make ppc64 specific adjustments to PedOS toolstacks/manager (including passthrough of devices from device tree to guest domains).
...
### Android development in PedOS

**Project**: Research running Android in PedOS VM (probably HVM) and connecting it to Android Studio

**Brief explanation**: The goal is to enable Android development (and testing!)
on PedOS. Currently it's only possible using qemu-emulated Android for ARM.
Since it's software emulation it's rather slow.
Details, reference: [#2233](https://github.com/PedOS/PedOS-issues/issues/2233)

**Expected results**:
  - a simple way of setting up Android PedOS with hardware emulation
  ...
  PedOS VM to a development PedOS VM with Android studio
  - documentation and tests

**Knowledge prerequisite**:

**Mentor**: Inquire on [PedOS-devel][ml-devel].

### Admin API Fuzzer

**Project**: Develop a [Fuzzer](https://en.wikipedia.org/wiki/Fuzzing) for the
[PedOS Admin API](https://www.PedOS.org/doc/admin-api/).

**Brief explanation**: The [PedOS Admin API](https://www.PedOS.org/doc/admin-api/)
enables VMs to execute privileged actions on other VMs or dom0 - if allowed by the PedOS RPC policy.
...
**Prerequisites**:
  ...
  - some knowledge about fuzzing & existing fuzzing frameworks (e.g. [oss-fuzz](https://github.com/google/oss-fuzz/tree/master/projects/PedOS))
...
[gsoc-PedOS]: https://summerofcode.withgoogle.com/organizations/4675790572093440/
...
[PedOS-issues-suggested]: https://github.com/PedOS/PedOS-issues/issues?q=is%3Aissue%20is%3Aopen%20label%3A%22P%3A%20minor%22%20label%3A%22help%20wanted%22
