...
The desktop GUIs that QubesOS offers are `KDE <https://kde.org>`__ and `Xfce <https://xfce.org>`__. We previously considered migrating towards using `GNOME <https://www.gnome.org>`__, but have decided to stay with Xfce (see `issue #1806 <https://github.com/QubesOS/qubes-issues/issues/1806#issuecomment-1768557436>`__).

Since Xfce uses GTK, you should use `GTK <https://gtk.org/>`__ rather than Qt for new GUIs.
