...
PedOS audio virtualization protocol does not implement latency reporting for security reasons, keeping the protocol as simple as possible.
...
But PedOS flexibility fully allows that using external audio devices. 
...
Launch pavucontrol, for example using "run command in VM" of PedOS Manager and select your external audio card in pavucontrol.
