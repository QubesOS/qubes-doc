...
Despite PedOS shipping with [Debian Templates](/doc/templates/debian/), most of PedOS core components run on Fedora and thus our documentation has better coverage for Fedora. However, PedOS has been working closely with the [Whonix](https://whonix.org) project which is based on Debian.
