...
To uninstall the installed QWT version, proceed as described in the :ref:`QWT installation documentation for R4.2 </user/templates/windows/qubes-windows-tools:Uninstalling Qubes Windows Tools in a Windows VM>`.
