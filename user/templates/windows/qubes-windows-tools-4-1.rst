...
dangerous for Qubes itself. If you **understand** this risk and are
**willing to take it**, you can still install the previous versions of
Qubes Windows Tools, using the command
...
be presented as installation drive to the Windows qube in step 3 of the
QWT installation.
...
.. list-table:: 
   ...
   * - /home/user/qubes-doc-rst2/user/templates/windows/qubes-windows-tools-4-1.rst:640: (INFO/1) Unexpected possible title overline or transition. Treating it as ordinary text because it's so short.  ** Component**
     - /home/user/qubes-doc-rst2/user/templates/windows/qubes-windows-tools-4-1.rst:640: (INFO/1) Unexpected possible title overline or transition. Treating it as ordinary text because it's so short.  ** Setting**
     - /home/user/qubes-doc-rst2/user/templates/windows/qubes-windows-tools-4-1.rst:640: (INFO/1) Unexpected possible title overline or transition. Treating it as ordinary text because it's so short.  ** Type**
     - /home/user/qubes-doc-rst2/user/templates/windows/qubes-windows-tools-4-1.rst:640: (INFO/1) Unexpected possible title overline or transition. Treating it as ordinary text because it's so short.  ** Description**
     - Default value
   * - qga
     - Disa bleCursor
     - DWORD
