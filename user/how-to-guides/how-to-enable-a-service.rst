...
2. Go to the :guilabel:`Services` tab
   ...
   .. image:: /attachment/doc/r4.3/settings-services.png
      :alt:
      :width: 100%
...
3. You have two options, depending on the current list of the services:
   ...
   * If the service is not listed:
     ...
     1. Select it in the :guilabel:`Select a service` drop-down.
        ...
        .. image:: /attachment/doc/r4.3/settings-services-drop-down.png
           :alt:
           :width: 100%
     ...
     2. Click on :guilabel:`Add`
        ...
        .. image:: /attachment/doc/r4.3/settings-services-add.png
           :alt:
           :width: 100%
