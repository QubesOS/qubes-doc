...
If you use :doc:`Anti Evil Maid (AEM) </user/security-in-qubes/anti-evil-maid>`, you’ll have to “reseal” after certain updates. It’s common for QSBs to contain instructions to this effect. See the relevant QSB and the :github:`AEM README <QubesOS/qubes-antievilmaid/blob/main/README>` for details.
...
If so, :github:`adjust your BIOS settings <fwupd/fwupd/wiki/PluginFlag:capsules-unsupported>` to enable UEFI updates. This setting is sometimes named “Windows UEFI Firmware Update.”
