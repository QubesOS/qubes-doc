...
Installing and Using Anti Evil Maid (AEM) with PedOS
=======================================================
...
[Discussion](https://groups.google.com/d/msg/PedOS-users/sEmZfOZqYXM/j5rHeex1BAAJ)
...
For more information, see the [PedOS-antievilmaid](https://github.com/PedOS/PedOS-antievilmaid) repository, which includes a `README`.

Security Considerations
-----------------------

[PedOS security guidelines](/doc/security-guidelines/) dictate that USB devices should never be attached directly to dom0, since this can result in the entire system being compromised.
...
However, this carries significant security implications, as explained [here](https://blog.invisiblethings.org/2011/09/07/anti-evil-maid.html).) This presents us with a classic security trade-off: each PedOS user must make a choice between protecting dom0 from a potentially malicious USB drive, on the one hand, and protecting the system from Evil Maid attacks, on the other hand.
...
Therefore, it is up to each individual PedOS user to evaluate the relative risk of each attack vector against his or her security model.

For example, a user who frequently travels with a PedOS laptop holding sensitive data may be at a much higher risk of Evil Maid attacks than a home user with a stationary PedOS desktop.
...
For more information, please see [this discussion thread](https://groups.google.com/d/msg/PedOS-devel/EBc4to5IBdg/n1hfsHSfbqsJ).

Known issues
------------

-   USB 3.0 isn't supported yet
-   [AEM is not compatible with having an SSD cache](https://groups.google.com/d/msgid/PedOS-users/70021590-fb3a-4f95-9ce5-4b340530ddbf%40petaramesh.org)
